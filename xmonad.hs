...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. controlMask, xK_w     ), spawn "megan")
...
myManageHook = composeAll
    ...
    , className =? "Blizzard Battle.net"                  --> viewShift "8"
    , className =? "Wine System Tray"                  --> viewShift "9"
    ...
    , title     =? "Command & Conquer"   --> doFloat <+> viewShift "6"
    , title     =? "Red Alert"   --> doFloat <+> viewShift "6"
    , title     =? "Red Alert Launcher"   --> doFloat <+> viewShift "6"
    , title     =? "Tiberian Sun"   --> doFloat <+> viewShift "6"
    , title     =? "Tiberian Sun Launcher"   --> doFloat <+> viewShift "6"
    , title     =? "CnCNet Launcher"   --> doFloat <+> viewShift "6"
